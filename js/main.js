...
var app = {
    ...
    init: function() {
        ...
        $(window).scroll(function(event) {
            ...
            $("#mainmenu .menu li").eq(indice[indice.length - 1]).addClass("active");
        });
        this.sliders();
    },
    ...
    sliders: function() {
        ...
        $("#slider1, #slider2, #slider3, #slider4,  #slider5, #slider6, #slider7, #slider8, #slider9").slick({
            dots: false,
            speed: 1500,
            slidesToShow: 1,
            slidesToScroll: 1,
...
$("#slider-1, #slider-2, #slider-3, #slider-4,  #slider-5, #slider-6, #slider-7, #slider-8, #slider-9").slick({
    dots: true,
    speed: 1500,
    slidesToShow: 1,
    slidesToScroll: 1,
...
window.onload = function() {
    ...
    $(".loader").remove();
    $('#verano .animacion-plants').addClass('crecer');
    $('#verano .animacion-plants2').addClass('crecer');
};
